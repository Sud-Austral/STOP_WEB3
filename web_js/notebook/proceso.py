...
if not os.path.exists(url):
    url = r"estadistica_stop/ESTADISTICA_DELITO.csv" 
if not os.path.exists(url):
    # Fallback añadido por seguridad si ejecutamos en web_js/notebook y el archivo está en data/input
...
base_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) # web_js
